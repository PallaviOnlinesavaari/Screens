        ...
        <SafeAreaView style={{flex:1,backgroundColor:"#ffffff"}}>
            <KeyboardAvoidingView  behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
                <View style={styles.viewCenter}>
                    ...
                    <Text style={styles.title}>To get started now</Text>
                    <View>
                    <TextInput
                    ...
                    <View>
                        ...
                        <View style={styles.textFlex}>
                            <Text style={{fontFamily:"QuattrocentoSans-Bold",color:Color.darkBlack}}>Already have an account ? </Text>
                            <TouchableHighlight>
                                <Text style={{color:Color.red,fontFamily:"QuattrocentoSans-Bold"}}>Login</Text>
                            </TouchableHighlight>
                        </View>
                </View>
